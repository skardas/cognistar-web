      ...
      <main className="flex-1 py-16 sm:py-24">
        <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-16 space-y-12">
            ...
            {/* Section 1: COPPA */}
            <div className="relative overflow-hidden rounded-3xl border border-slate-200/60 dark:border-white/5 bg-white dark:bg-slate-900/30 p-8 shadow-xs">
              <div className="flex items-center gap-3">
                <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-purple-500/10 text-purple-600 dark:text-purple-400">
                  <HeartHandshake className="h-5 w-5" />
                </div>
                <h2 className="text-lg font-bold text-slate-900 dark:text-white">{t('coppa_title')}</h2>
              </div>
            ...
            <div className="relative overflow-hidden rounded-3xl border border-slate-200/60 dark:border-white/5 bg-white dark:bg-slate-900/30 p-8 shadow-xs">
              <div className="flex items-center gap-3">
                ...
                <h2 className="text-lg font-bold text-slate-900 dark:text-white">{t('storage_title')}</h2>
              </div>
              <p className="mt-4 text-sm text-slate-600 dark:text-slate-400 leading-relaxed">
                {t('storage_desc')}
              </p>
